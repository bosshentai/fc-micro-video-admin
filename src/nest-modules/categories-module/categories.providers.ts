...
export const REPOSITORIES = {
  ...
  CATEGORORY_IN_MEMORY_REPOSITORY: {
    provide: CategoryInMemoryRepository,
    useClass: CategoryInMemoryRepository,
  },
  CATEGORY_SEQUELIZE_REPOSITORY: {
    provide: CategorySequelizeRepository,
    useFactory: (categoryModiel: typeof CategoryModel) => {
      return new CategorySequelizeRepository(categoryModiel);
    },
...
export const VALIDATIONS = {
  CATEGORIES_ID_EXISTS_IN_DATABASE_VALIDATOR: {
    provide: CategoriesIdExistisInDatabaseValidator,
    useFactory: (categoryRepo: ICategoryRepository) => {
      return new CategoriesIdExistisInDatabaseValidator(categoryRepo);
    },
    inject: [REPOSITORIES.CATEGORY_REPOSITORY.provide],
  },
};
