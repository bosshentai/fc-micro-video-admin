...
import { VALIDATIONS } from './../categories-module/categories.providers';
...
export const REPOSITORIES = {
  ...
  VIDEO_IN_MEMORY_REPOSITORY: {
    ...
    useClass: VideoSequelizeRepository,
  },
  ...
  CREATE_VIDEO_USE_CASE: {
    ...
    inject: [
      ...
      CATEGORY_PROVIDERS.VALIDATIONS.CATEGORIES_ID_EXISTS_IN_DATABASE_VALIDATOR
        .provide,
      GENRES_PROVIDERS.VALIDATIONS.GENRES_ID_EXISTS_IN_DATABASE_VALIDATOR
        .provide,
