...
describe('VideoInMemoryRepository', () => {
  ...
  it('should no filter items when filter object is null', async () => {
    const items = [
      Video.fake().aVideoWithAllMedias().build(),
      Video.fake().aVideoWithAllMedias().build(),
    ];
  ...
  it('should sort by created_at when sort param is null', async () => {
    const items = [
      Video.fake().aVideoWithAllMedias().withCreatedAt(new Date()).build(),
      Video.fake()
        .aVideoWithAllMedias()
  ...
  it('should sort by title', async () => {
    const items = [
      Video.fake().aVideoWithAllMedias().withTitle('c').build(),
      Video.fake().aVideoWithAllMedias().withTitle('b').build(),
      Video.fake().aVideoWithAllMedias().withTitle('a').build(),
    ];
