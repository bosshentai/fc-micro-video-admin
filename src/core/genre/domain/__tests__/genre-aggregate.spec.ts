...
describe('Genre Unit Tests', () => {
  ...
  describe('genre_id field', () => {
    ...
    const arrange = [
      { name: 'Movie', categories_id: categoriesId },
      { name: 'Movie', categories_id: categoriesId, id: null },
      { name: 'Movie', categories_id: categoriesId, id: undefined },
      { name: 'Movie', categories_id: categoriesId, id: new GenreId() },
    ];

    test.each(arrange)('should create a genre with $name', (item) => {
  ...
  describe('create command', () => {
    test('should create a genre', () => {
      ...
      expect(genre2.categories_id).toEqual(categoriesId);
