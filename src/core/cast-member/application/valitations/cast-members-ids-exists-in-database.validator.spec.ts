...
describe('CastMembersIdExistsInDatabaseValidator', () => {
  ...
  it('should return many not found error when cast members is not exists in storage', async () => {
    ...
    expect(castMembersId).toStrictEqual(undefined);
  ...
  it('should return a list of categories id', async () => {
    ...
    expect(errorsCastMembersId).toStrictEqual(undefined);
